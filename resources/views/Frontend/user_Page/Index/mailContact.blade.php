<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Cửa hàng bán giày NORDA</title>
    </head>
    <body
                    ...
                    <div class="row" style="background-color: #00509d; height: 200px; padding: 35px; color: white;">
                        <div class="container-fluid">
                            <h3 class="m-0 p-0 mt-4" style="margin-top: 0; font-size: 28px; font-weight: 500;">
                                <strong style="font-size: 18px;">Thông báo nhận tin nhắn từ khách hàng {{$name}}</strong>
                                <br>
                                Cảm ơn rất nhiều
                            </h3>
                            <div class="row mt-5" style="margin-top: 35px; display: flex;">
                                <div class="col-6"
                                    ...
                                    <b>{{$name}}</b>
                                    <br>
                                    <span > <a style="color: white !important;" href="mailto:{{ $email }}" target="_blank">{{ $email }}</a></span>
                                    <br>
                                    <span>{{ $phone }}</span>
                                </div>
                            </div>
                    ...
                    <div class="row mt-2" style="margin-top: 15px;">
                        <div class="container-fluid">
                            <div class="row pl-3 py-2" style="background-color: #f4f8fd; padding: 10px 0 10px 20px;">
                                <b>Chi tiết Tin nhắn phản hồi từ khách hàng</b>
                            </div>
